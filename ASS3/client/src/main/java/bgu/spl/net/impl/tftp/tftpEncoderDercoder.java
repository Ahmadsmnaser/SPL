...
public class tftpEncoderDercoder implements MessageEncoderDecoder<byte[]> {
    ...
    public static void reset() {
        tftpEncoderDercoder.opcode = -1;
        tftpEncoderDercoder.errorcode = -1;
        tftpEncoderDercoder.blocknum = -1;
        tftpEncoderDercoder.packetsize = -1;
        tftpEncoderDercoder.currsize = 0;
        len = 0;
    }
}
